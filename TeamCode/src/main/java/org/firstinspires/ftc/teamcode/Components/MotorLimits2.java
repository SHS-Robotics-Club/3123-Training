...
public class MotorLimits2 {
    ...
    private static final int INIT_POSITION = 0;  // Position B
    private static final double LOW_POWER_FACTOR_LIMIT = 0.25;  // Low power factor
    private static final double HIGH_POWER_FACTOR_LIMIT = 1.0; // High power factor
    private static final int LOW_POSITION_LIMIT = -200;  // Position A
    private static final int HIGH_POSITION_LIMIT = 200;  // Position B
     ...
     */
    public MotorLimits2(HardwareMap hardwareMap, Telemetry telemetry) {
...
//        m_tb.setPower(HIGH_POWER_FACTOR_LIMIT * powerFactor); // Apply full power with power factor
        m_tb.setPower(LOW_POWER_FACTOR_LIMIT); // Apply full power with power factor
